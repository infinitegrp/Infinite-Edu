...
export default function Years() {
    return (
        <>
            ...
            <h1 className='font-bold text-4xl md:text-4xl text-black dark:text-gray-100'>15+</h1>
            ...
            <Image src="/images/laptop.png" alt="Computer man" width={180} height={180} className='p-5 w-15 h-15 hidden md:block ' />
            </div>
