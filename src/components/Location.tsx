   ...
   return (
      <div className="grid grid-cols-1 lg:grid-cols-2 max-w-screen-2xl gap-10 justify-center">
         {locations.map((data, index) => (
            <div key={index} className="flex flex-col w-full max-w-[700px] items-center">
                  ...
                  <div className='flex absolute bg-gray-50 dark:bg-gray-900 py-2 md:py-3 px-4 md:px-8 rounded-xl backdrop-blur-xl opacity-90 justify-start items-center mt-28 md:mt-40  '>
                     <div className="flex flex-row items-center gap-8">
                        <p className='w-[60vw] md:w-full text-neutral-400 text-xs md:text-md leading-5'><span className='font-bold dark:text-gray-50 text-sm md:text-md'>
                           Infinite group of Companies {data?.title}</span> <br />{data?.address_line_1}<br />{data?.address_line_2}<br />{data?.address_line_3}
                           <br />
               ...
               <p className='w-full text-black dark:text-neutral-400 text-md text-center pt-10'>
                  <span className='font-bold text-gray-50'>Infinite group of Companies {data?.title}</span>
                  <br />{data?.address_line_1}<br />{data?.address_line_2}<br />{data?.address_line_3}
                  <br /><br />Ph : {data?.ph}<br /> Mail : info@Infiniteedu.com
