                    ...
                    <div className='flex absolute bg-gray-50 dark:bg-gray-900 py-2 md:py-3 px-4 md:px-8 rounded-xl backdrop-blur-xl opacity-90 justify-start items-center mt-28 md:mt-40  '>
                        <div className="flex flex-row items-center gap-8">
                            <p className='w-[60vw] md:w-full text-neutral-400 text-xs md:text-md leading-5'><span className='font-bold dark:text-gray-50 text-sm md:text-md'>
                                Aspin Commercial Tower</span> <br />106 Sheikh Zayed Rd - Trade Centre -  <br />Trade Centre 1 - Dubai - United Arab Emirates
                                <br />
                                <Link href={`https://www.google.com/maps?ll=25.208963,55.272498&z=13&t=m&hl=en-US&gl=US&mapclient=embed&q=Aspin+Commercial+Tower+106+Sheikh+Zayed+Rd+Trade+Centre+-+Trade+Centre+1+-+Dubai+United+Arab+Emirates`}>
                                    <span className='text-blue-500'>View larger map</span>
                                </Link>
                            </p>
                            <Link href={`https://www.google.com/maps/dir//Aspin+Commercial+Tower+106+Sheikh+Zayed+Rd+Trade+Centre+-+Trade+Centre+1+-+Dubai+United+Arab+Emirates/@25.2089625,55.2724984,13z/data=!4m8!4m7!1m0!1m5!1m1!1s0x3e5f428853023db3:0x6e63a9fe6b2d7cfe!2m2!1d55.2724984!2d25.2089625?entry=ttu`}>
