      ...
      <BorderLineCard className='h-52 md:h-60 overflow-hidden'>
        <div className='h-full w-full justify-center items-start  overflow-hidden flex flex-col relative bg-white dark:bg-neutral-950'>
          <div className="px-3 md:px-5 lg:px-10  ">
            <h1 className='font-bold text-xl text-black dark:text-white pt-7 md:pt-3'>Study Internationally</h1>
          ...
          <Image src="/gif/earth.gif" alt="bg" onClick={() => setOpen(true)} width={340} height={340} className='w-[45%] dark:hidden opacity-20 absolute right-[30%]' />
        ...
        <div className="h-[70vh] w-full gap-2 md:gap-5  dark:bg-[#212227] bg-white flex flex-col items-center justify-between ">
          ...
          <div className='flex flex-row gap-5'>
            ...
            <div className='rounded-2xl flex flex-col min-w-40 max-w-[20rem] items-center justify-center bg-white dark:bg-neutral-900 shadow-[rgba(0,_0,_0,_0.2)_0px_60px_40px_-7px] px-5 py-5 gap-2 '>
              <h1 className=' text-black dark:text-white font-bold text-lg text-center'><span className='text-2xl'>33+</span> Countries</h1>
            ...
            <div className='rounded-2xl flex flex-col min-w-40 max-w-[20rem] items-center justify-center bg-white dark:bg-neutral-900 shadow-[rgba(0,_0,_0,_0.2)_0px_60px_40px_-7px] px-5 py-5 gap-2 '>
              <h1 className=' text-black dark:text-white font-bold text-lg text-center'><span className='text-2xl'>700+</span> Universities</h1>
