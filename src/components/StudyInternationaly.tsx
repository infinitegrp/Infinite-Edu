    ...
    return (
        <div className='overflow-hidden cursor-pointer'>
            <BorderLineCard className='h-60 overflow-hidden'>
                ...
                <Image src="/gif/textearth.gif" alt="bg" onClick={()=>setOpen(true)} width={480} height={480} className='w-full  opacity-20 absolute' />
                </div>
            </BorderLineCard>
                ...
                <div className="h-[70vh] w-full gap-2 md:gap-5  dark:bg-[#212227] bg-white flex flex-col items-center justify-between ">
                    ...
                    <div className='flex flex-row gap-5'>
                        ...
                        <div className='rounded-2xl flex flex-col min-w-40 max-w-[20rem] items-center justify-center bg-white dark:bg-neutral-900 shadow-[rgba(0,_0,_0,_0.2)_0px_60px_40px_-7px] px-5 py-5 gap-2 '>
                            <h1 className=' text-black dark:text-white font-bold text-lg '><span className='text-2xl'>30+</span> Countries</h1>
                            <p className=' text-black dark:text-gray-400 text-xs text-center'>Operating in 30+ countries, our extensive partnerships form the backbone of our global presence.</p>
                        </div>
                        <div className='rounded-2xl flex flex-col min-w-40 max-w-[20rem] items-center justify-center bg-white dark:bg-neutral-900 shadow-[rgba(0,_0,_0,_0.2)_0px_60px_40px_-7px] px-5 py-5 gap-2 '>
