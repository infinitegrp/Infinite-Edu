...
export default function StudyInternationaly() {
    ...
    return (
        <div className='py-10 px-8 '>
            ...
            <p className=' lg:text-md text-gray-500 dark:text-white pt-5 pr-80'>
            ...
            <ModalLayout open={open} setOpen={setOpen} title='' width={1000}>
                <div className="h-[70vh] w-full gap-1 md:gap-2  dark:bg-black bg-white flex flex-col items-center justify-center ">
