...
export default function WorkInDubai() {
   return (
      <div className='pt-10 px-8 '>
         <h1 className='font-bold text-xl text-black dark:text-white'>Study and Work in Dubai
         </h1>
         ...
         <Image src="/images/dubai.png" alt="dubai" width={480} height={480} className='w-full h-100 ml-auto' />
         </div>
