...
const Blog = ({ data }: { data: Props }) => {
   ...
   return (
      <section className="pt-[100px] pb-[100px] bg-[#FEFDFD] dark:bg-black flex items-center justify-center">
         <div className="container p-10 w-full">
            <div className="-mx-4 flex flex-wrap justify-center">
               <div className="w-full px-4 lg:w-8/12">
                  <div>
                     <h2 className="mb-8 text-3xl font-bold leading-tight text-black dark:text-gray-300 sm:text-4xl sm:leading-tight">
                        {data?.title}
                     </h2>
                     <div className="mb-10 flex flex-wrap items-center justify-between border-b border-gray-300 pb-4 dark:border-white dark:border-opacity-50">
                        <div className="flex flex-wrap items-center">
                           ...
                           <div className="mb-5 flex items-center">
                              <p className="flex items-center text-xs md:text-sm font-medium text-black dark:text-gray-300">
                              ...
                              {/* <p className="mr-5 flex items-center text-base font-medium text-black dark:text-gray-300">
                                 <span className="mr-3">
                                    <svg
                                       width="18"
                                       height="13"
                              ...
                              <p className="flex items-center text-base font-medium text-black dark:text-gray-300">
                                 <span className="mr-3">
                                    <svg
                                       width="20"
                                       height="12"
                        ...
                        <div className="mb-5">
                           <p className="hidden md:flex items-center text-xs md:text-sm font-medium text-black dark:text-gray-300">
                     ...
                     <div>
                        <p className="mb-10 text-base font-medium leading-relaxed text-black dark:text-gray-300 sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                           {data?.subtitle}
                        </p>
                        ...
                        <p className="mb-8 text-base font-medium leading-relaxed text-black dark:text-gray-300 sm:text-lg sm:leading-relaxed lg:text-base lg:leading-relaxed xl:text-lg xl:leading-relaxed">
                           {formatDescription(data?.description)}
                        </p>
                        <Link className='text-blue-500 hover:underline' target='_blank' href={data?.url}>know more</Link>
                        <div className="items-center justify-between sm:flex">
                           {/* <div className="mb-5">
                              <h5 className="mb-3 text-sm font-medium text-black dark:text-gray-300">
                                 Popular Tags :
                              </h5>
                           ...
                           <div className="mb-5 flex items-center">
                              <h5 className="mb-3 text-sm font-medium text-black dark:text-gray-300 sm:text-right">
                                 Share this post :
                              </h5>
                              <div className="flex items-center sm:justify-end">
                                 <a
                                    href={`https://www.linkedin.com/sharing/share-offsite/?url=https://www.infinite-edu.com/blogs`}
                                    target="_blank"
                                 ...
                                 <a
                                    href={`https://twitter.com/intent/tweet?url=https://www.infinite-edu.com/blogs/${data?._id}text=Check%20this%20out`}
                                    target="_blank"
                                 ...
                                 <a
                                    href={`https://www.facebook.com/sharer/sharer.php?u=https://www.infinite-edu.com/blogs/${data?._id}`}
                                    target="_blank"
                                    className="ml-3 mb-3 inline-flex h-9 w-9 items-center justify-center rounded-md  dark:bg-black text-black dark:text-white bg-opacity-10 duration-300 hover:bg-opacity-100 hover:text-gray-500"
                                 >
