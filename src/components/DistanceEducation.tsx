...
export default function DistanceEducation() {
    ...
    return (
        ...
        <div className='py-6 px-8 '>
            ...
            <p className='text-sm lg:text-base text-gray-500 dark:text-white pt-3 '>
            ...
            <Card>
                <div className="flex flex-col">
                    ...
                    <p className='text-sm lg:text-base text-gray-500 dark:text-white pt-2 '>
