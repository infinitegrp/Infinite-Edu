...
export default function DistanceEducation() {
    ...
    return (
        ...
        <div className='py-3 md:py-4 lg:py-6 px-3 md:px-4 lg:px-8 bg-white dark:bg-neutral-950'>
            ...
            <p className='text-sm lg:text-base text-gray-300 dark:text-gray-300 pt-3 '>
            ...
            <BorderLineCard className='w-full h-full flex justify-center items-center p-3 px-4 overflow-hidden relative dark:bg-transparent'>
                <div className="flex flex-col">
                    ...
                    <p className='text-xs lg:text-sm text-gray-300 dark:text-gray-300 pt-1 '>
                ...
                <button onClick={()=>setOpen(true)} className="md:mx-1 lg:mx:3 px-1 h-8 animate-shimmer items-center flex flex-row rounded-2xl border border-slate-800 bg-[linear-gradient(110deg,#000103,45%,#1e2631,55%,#000103)] bg-[length:200%_100%]  text-sm text-slate-400 transition-colors focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
                ...
                <Image src="/gif/lightblue.gif" alt="Computer man" width={480} height={480} className='w-full  opacity-5 absolute' />
            </BorderLineCard>
            ...
            <BorderLineCard className='w-full h-full flex justify-center items-center p-3 px-4 overflow-hidden relative dark:bg-transparent'>
                ...
                <Image src="/gif/lightblue.gif" alt="Computer man" width={480} height={480} className='w-full z-20 opacity-5 absolute' />
            </BorderLineCard>
        ...
        <ModalLayout open={open} setOpen={setOpen} title='' width={1000}>
                <div className="h-[70vh] w-full gap-1 md:gap-2  dark:bg-neutral-950 bg-white flex flex-col items-center justify-center ">
                    <Image src={'/images/fastTrack.png'} alt='fastTrack' width={500} height={100} className='h-40 w-60' />
                    ...
                    For those who prefer a traditional learning environment, our on-campus programs provide a comprehensive educational experience tailored to meet your needs. With our meticulously designed curriculum and UGC-approved courses, you can embark on a journey of academic excellence in a supportive and enriching atmosphere. Whether you're a working professional seeking to enhance your skills or an individual looking to complete your education, our on-campus offerings provide the resources and guidance you need to succeed. Join us and earn a respected degree that opens doors to endless opportunities in your chosen field.
                    </p>
