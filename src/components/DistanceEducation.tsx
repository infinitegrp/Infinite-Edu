    ...
    return (
        ...
        <div className='py-3 md:py-4 lg:py-6 px-3 md:px-4 lg:px-8 bg-white dark:bg-neutral-950'>
            ...
            <BorderLineCard className='w-full h-full flex justify-center items-center p-3 px-4 overflow-hidden relative dark:bg-transparent'>
                ...
                <Image src="/gif/lightblue.gif" alt="Computer man" width={480} height={480} className='h-full md:w-full  opacity-5 absolute' />
            </BorderLineCard>
            ...
            <BorderLineCard className='w-full h-full flex justify-center items-center p-3 px-4 overflow-hidden relative dark:bg-transparent'>
                ...
                <Image src="/gif/lightblue.gif" alt="Computer man" width={480} height={480} className='h-full md:w-full z-20 opacity-5 absolute' />
            </BorderLineCard>
