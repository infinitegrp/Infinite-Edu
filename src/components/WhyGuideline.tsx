        ...
        <div className="pt-10 h-[43rem] w-full dark:bg-black bg-white flex flex-col items-center justify-start overflow-hidden rounded-md">
            ...
            <div className="flex flex-row items-center justify-center">
                <div className="flex justify-center flex-col absolute items-center">
                    <p className="text-center w-[50vh] pt-20 pb-6 dark:text-gray-300 text-gray-700">We are authorized to manage student enrolments for universities and colleges.  </p>
                    <div className=" max-w-screen-2xl px-5 my-2 md:px-40 lg:px-80  flex flex-row justify-center items-start gap-4">
                      ...
                      bg-[length:200%_100%] px-2 text-sm text-slate-400 transition-colors focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
                        ...
                        <p className="dark:text-gray-400 text-gray-700 text-md"><span className="dark:text-gray-300">Guideline Educational Institution is committed to transparency, ensuring that students make their payments directly to their chosen college or
                      ...
                      bg-[length:200%_100%] px-2 text-sm text-slate-400 transition-colors focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
                        ...
                        <p className="dark:text-gray-400 text-gray-700 text-md"><span className="dark:text-gray-300">Become a part of Guideline Group's extensive alumni network,</span> connecting with a community of successful graduates and professionals who have benefitted
