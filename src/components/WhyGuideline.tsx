...
export function WhyGuideline() {
    ...
    return (
        <div className="pt-10 h-[43rem] w-full dark:bg-black bg-white flex flex-col items-center justify-start overflow-hidden rounded-md">
            <h1 className="md:text-4xl pb-5 text-3xl lg:text-4xl font-bold text-center text-black dark:text-white relative z-20">
                Why Guideline
            </h1>
            <div className="w-[40rem] h-40 relative ">
                ...
                <div className="absolute flex justify-center w-full items-center h-full">
                    ...
                    <svg width="800" height="800" viewBox="0 0 800 800" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <circle cx="406" cy="393" r="248.5" stroke="#CCCFE1" stroke-opacity="0.05" stroke-width="3" />
                        <circle cx="400" cy="400" r="398.5" stroke="url(#paint0_linear_24_3)" stroke-opacity="0.05" stroke-width="3" />
                        <defs>
                            <linearGradient id="paint0_linear_24_3" x1="400" y1="0" x2="400" y2="800" gradientUnits="userSpaceOnUse">
                                <stop stop-color="#CCCFE1" stop-opacity="0" />
                                <stop offset="0.35" stop-color="#6F717B" />
                                <stop offset="0.666667" stop-color="#6F717B" stop-opacity="0.681416" />
                                <stop offset="1" stop-color="#6F717B" stop-opacity="0" />
                            </linearGradient>
                        </defs>
                    </svg>
                </div>
            ...
            <div className="flex flex-row items-center justify-center">
                <div className="flex justify-center flex-col absolute items-center">
                    <p className="text-center w-[50vh] pt-20 pb-6 dark:text-gray-300">We are authorized to manage student enrolments for universities and colleges.  </p>
                    <div className=" max-w-screen-2xl px-5 my-2 md:px-40 lg:px-80  flex flex-row justify-center items-start gap-4">
                        <button className="mt-1 mb-4 h-8 animate-shimmer items-center flex flex-row rounded-xl border border-gray-800 bg-[linear-gradient(110deg,#5858fb,45%,#9595f7,55%,#5858fb)]
                      bg-[length:200%_100%] px-2 text-sm text-slate-400 transition-colors focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
                        ...
                        <p className="dark:text-gray-400 text-md"><span className="dark:text-gray-300">Guideline Educational Institution is committed to transparency, ensuring that students make their payments directly to their chosen college or
                      ...
                      bg-[length:200%_100%] px-2 text-sm text-slate-400 transition-colors focus:outline-none focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 focus:ring-offset-slate-50">
                        ...
                        <p className="dark:text-gray-400 text-md"><span className="dark:text-gray-300">Become a part of Guideline Group's extensive alumni network,</span> connecting with a community of successful graduates and professionals who have benefitted
                            from our educational programs and are now making significant strides in their respective fields.</p>
                    </div>
                    <p className="text-center w-[50vh] pt-10 dark:text-gray-300 font-bold text-lg">What is guideline group <span className="text-indigo-500">alumni ?</span> </p>
                    <div className="flex flex-row">
                        <p className="text-center  pt-1 dark:text-gray-300  text-sm">known more  </p>
            ...
            <ModalLayout open={open} setOpen={setOpen} title='' width={1000}>
                <div className="h-[70vh] w-full gap-1 md:gap-2  dark:bg-neutral-950 bg-white flex flex-col items-center justify-center ">
                    ...
                    <p className="pt-1 text-lg font-normal font-center text-center text-black dark:text-gray-400 mb-12 max-w-[40rem]">
