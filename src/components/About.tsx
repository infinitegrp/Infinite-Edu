...
export default function About() {
    ...
    return (
        <div className="max-w-screen-2xl px-5 my-2 md:px-20 lg:px-40 flex flex-col items-center">
            <p className="text-2xl md:text-4xl font-bold relative z-20 bg-clip-text text-transparent bg-gradient-to-b from-neutral-200 to-neutral-500 p-4 max-w-[40rem] text-center">Fueling company growth
                through mental well-being</p>
