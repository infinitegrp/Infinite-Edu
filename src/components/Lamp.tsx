...
export const Card = ({ children, className }: CardProps) => {
  return <motion.section
    className={cn(`rounded-xl h-full w-full dark:bg-neutral-900  bg-blue-50 border dark:border-gray-800   shadow-[0_8px_30px_rgb(0,0,0,0.12)] dark:shadow shadow-blue-50 overflow-hidden`,className)}
  ...
  return (
    <LampContainer>
      <motion.h1 initial={{ opacity: 0.5, y: 100 }} whileInView={{ opacity: 1, y: 0 }} transition={{ delay: 0.3, duration: 0.8, ease: "easeInOut", }}
        className="pb-20 text-4xl md:text-4xl font-bold relative z-20 bg-clip-text text-transparent bg-gradient-to-b from-black dark:from-neutral-200 to-neutral-500  max-w-[60rem] text-center">
