    ...
    <>
      <ModalLayout open={open} setOpen={setOpen} title='' width={1000} bgcolor="">
        <div className="pt-10 md:h-[40rem] h-[800px] w-[90vw] lg:w-[1000px] flex flex-col items-center justify-start overflow-hidden rounded-md">
          ...
          <div className="w-[30rem] md:w-[40rem] h-40 relative ">
          ...
          <div className="flex flex-row items-center justify-center w-full relative">
            <div className="flex justify-center flex-col pt-80 md:pt-0 absolute max-w-[90vw] items-center pr-5">
              ...
              <div className="flex flex-row">
                <p className="text-center  pt-1 dark:text-gray-300 text-gray-700 text-sm">
                  known more
                </p>
                <button
                  onClick={() => setopenAlumni(true)}
                  className="mt-1 ml-2 mb-4  animate-shimmer items-center flex-row rounded-2xl border border-gray-800 bg-[linear-gradient(110deg,#5858fb,45%,#9595f7,55%,#5858fb)]
                ...
                >
                  ...
                  >
                    <path
                      d="M3.11091 10.2052L10.0107 4.24561"
                      stroke="white"
                      strokeWidth="2"
                      strokeLinecap="round"
                    ...
                    />
                    <path
                      d="M10.1986 9.64438L10.2073 4.07522L4.69612 3.27373"
                      stroke="white"
                      strokeWidth="2"
                      strokeLinecap="round"
                      strokeLinejoin="round"
...
export default WhyInfinitePopup;