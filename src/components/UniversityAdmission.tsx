...
export default function UniversityAdmission() {
  return (
    <>
      <div className='h-full pb-2 md:pb-9 pt-4 md:pt-4 lg:pt-6 px-2.5 md:px-5 lg:px-8  bg-white dark:bg-neutral-950 cursor-pointer overflow-hidden'>
        <Link href="#contact" >
          ...
          <p className='text-xs md:text-sm lg:text-base text-gray-500 dark:text-gray-400 pt-1 md:pt-2'>
