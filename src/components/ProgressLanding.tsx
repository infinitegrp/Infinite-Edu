...
export default function ProgressLanding() {
    ...
    return (
    <div className='flex flex-col md:flex-row md:px-5 w-full justify-between max-w-screen-2xl '>
        <div className='flex flex-row lg:px-40'>
            <div className="p-2">
            <BorderLineCard className='h-40 justify-center items-center overflow-hidden bg-transparent dark:bg-transparent '>
                ...
                <div className="flex flex-col lg:w-44 absolute items-center justify-center">
                    ...
                    <p className=' text-black dark:text-gray-300 text-sm xl:text-lg font-bold'>Universities</p>
            ...
            <BorderLineCard className='h-40 justify-center items-center overflow-hidden bg-transparent dark:bg-transparent'>
                ...
                <div className="flex flex-col lg:w-44 absolute items-   center justify-center">
                    ...
                    <p className=' text-black dark:text-gray-300 text-lg font-bold'>Students</p>
                    <p className=' text-black dark:text-gray-400 text-xs text-center'>Lorem Ipsum is a dummy text for country without any sense that is used to fill spaces in graphic</p>
                </div>
            </BorderLineCard>
        ...
        <div className="flex flex-row lg:pr-4">
            ...
            <BorderLineCard className='h-40 justify-center items-center overflow-hidden bg-transparent dark:bg-transparent'>
                ...
                <div className="flex flex-col w-full lg:w-44 absolute items-center justify-center">
